...
(function ($) {
    ...
    hero_s.owlCarousel({
        ...
        autoHeight: false,
        autoplay: false,
        items: 1,              // يعرض شريحة واحدة في كل مرة
        loop: true,            // تكرار الشرائح عند الوصول للنهاية
        autoplay: true,        // تشغيل تلقائي
        autoplayTimeout: 3000, // تغيير كل 5 ثواني
        autoplayHoverPause: true, // إيقاف الحركة عند المرور بالفأرة
        nav: true,             // إظهار أزرار التنقل
        dots: true,            // إظهار النقاط السفلية
        animateOut: 'fadeOut', // إضافة تأثير الخروج
    });
